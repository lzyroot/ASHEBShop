...
-(void) initThreeDot
{
    ...
    _containerDotLayer.position = CGPointMake(self.center.x, 120);
    for (NSInteger i = 0; i < 3; i++)
    {
        ...
        switch (i) {
            case 0:
            {
                frame = CGRectMake(15, 0, 15, 15);
                break;
            }
            case 1:
            {
                frame = CGRectMake(0, 29.5, 15, 15);
                break;
            }
            case 2:
            {
                frame = CGRectMake(30.5, 29.5, 15, 15);
                break;
            }
            default:
                frame = CGRectMake(15, 0, 15, 15);
        ...
        dot.frame = frame;
        dot.backgroundColor = [UIColor mainColor].CGColor;
        dot.cornerRadius = 7.5;;
        dot.shadowColor = [UIColor mainRedColor].CGColor;
        dot.shadowOpacity = 1;
...
-(void) initAniamtion
{
    ...
    _colorGlowAnimation.keyTimes = @[[NSNumber numberWithFloat:0.0f],
                                [NSNumber numberWithFloat:0.5f],
                                [NSNumber numberWithFloat:1.0f]];
    _colorGlowAnimation.values = @[(id)[UIColor colorWithHexCode:@"#F84D52"].CGColor,
                              (id)[UIColor colorWithHexCode:@"#F84D52"].CGColor,
                              (id)[UIColor colorWithHexCode:@"#F84D52"].CGColor];
    ...
    _colorDotAnimation.keyTimes = @[[NSNumber numberWithFloat:0.0f],
                                [NSNumber numberWithFloat:0.5f],
                                [NSNumber numberWithFloat:1.0f]];
    _colorDotAnimation.values = @[(id)[UIColor colorWithHexCode:@"#F84D52"].CGColor,
                                  (id)[UIColor colorWithHexCode:@"#F84D52"].CGColor,
                                  (id)[UIColor colorWithHexCode:@"#F84D52"].CGColor];
